        ...
        <footer id="controls-bottom" class="bottom-footer" style="display: none;">
            ...
            <div class="control-group">
                ...
                <select id="color-theme">
                    <option value="default_ii">Default</option>
                    <option value="custom">Custom</option>
                </select>
            </div>
            <div class="control-group">
            ...
            <div class="control-group" style="display:flex;gap:8px;align-items:center;">
                <button id="export-all" style="background:#000;color:#fff;padding:8px 12px;">Export All Slideshow Items</button>
                <button id="export-diagrams-only" style="background:#000;color:#fff;padding:8px 12px;">Export Slideshow Diagrams Only</button>
